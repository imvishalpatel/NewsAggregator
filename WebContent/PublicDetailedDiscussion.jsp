...
// }   
               ...
               //<span id="tg12"class="badge">#Plitical</span>
                                                ...
                                                <img src="assest/images/default_profile.png" alt="User_Pic" width="30" height="25"style="margin-left: 421px;"/><a href="Controller?action=refuser&uname=<%=pb.getUsername()%>" style="float:right;"><%out.println(pb.getUsername());%></a>
                                            </h5>
                                            <!--                                                                                vote-->
                                            <!--                                                                        <button onclick="upvote('bgoyal2222' , '<%= pb.getid()%>')">rererere</button>-->
                                            <a  class="<%if (pb.getVoteValue(username) == 1) {
        out.print("fa fa-thumbs-up upvote");
    } else {
        out.print("fa fa-thumbs-up");
    }%>" aria-hidden="true" style="text-decoration:none; cursor:pointer;" onclick="upvote('<%=username%>', '<%= pb.getid()%>')"> </a> <label id='upvote'><%out.println(pb.getUpVotes());%></label>&nbsp;
                                            <a class="<%if (pb.getVoteValue(username) == -1) {
                                                                                        out.print("fa fa-thumbs-down downvote");
                                                                                    } else {
                                                                                        out.print("fa fa-thumbs-down");
                                                                                    }%>" aria-hidden="true" style="text-decoration:none; cursor:pointer" onclick="downvote('<%=username%>', '<%= pb.getid()%>')"></a><label id="downvote"> <%out.println(pb.getDownVotes());%> </label>&nbsp;
                                ...
                                <table border="0" id="Comment" width="800">
                                    ...
                                    <tr >
                                        <td>
                                            ...
                                            <br/></br>
                                            <!--                                                                        comment vote-->
                                            <a class="<%if (comm.get(j).getVoteValue(username) == 1) {
        out.print("fa fa-thumbs-up upvote");
    } else {
        out.print("fa fa-thumbs-up");
    }%>" aria-hidden="true" style="text-decoration:none; cursor:pointer" onclick="upvoteComment('<%=username%>', '<%= pb.getid()%>', '<%=comm.get(j).getId()%>', 'upvote<%=j%>', 'downvote<%=j%>')"> </a> <label id='upvote<%=j%>'><%out.println(comm.get(j).getUpVotes());%></label>&nbsp;
                                            <a class="<%if (comm.get(j).getVoteValue(username) == -1) {
                                                                                out.print("fa fa-thumbs-down downvote");
                                                                            } else {
                                                                                out.print("fa fa-thumbs-down");
                                                                            }%>" aria-hidden="true" style="text-decoration:none; cursor :pointer" onclick="downvoteComment('<%=username%>', '<%= pb.getid()%>', '<%=comm.get(j).getId()%>', 'upvote<%=j%>', 'downvote<%=j%>')"></a><label id='downvote<%=j%>'><%=comm.get(j).getDownVotes()%></label>&nbsp;
