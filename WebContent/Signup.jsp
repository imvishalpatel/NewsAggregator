...
<html lang="en">
    ...
    <div class="container" style="margin-top: 54px;">
                        ...
                        <div class="panel panel-default">
                                <div class="panel-body">
                                        ...
                                        <p class="text-center text-muted">
                                                If not register yet, then <a href="signup.html">Register</a> and make your new profile. 										  							</p>
                                        <hr>
        ...
        <ul class="nav nav-tabs">
            <li class="<c:if test="${requestScope.signupErr eq null}">active</c:if>"><a data-toggle="tab" href="#signin">SIGNIN</a></li>
            <li class="<c:if test="${requestScope.signupErr ne null}">active</c:if>"><a data-toggle="tab" href="#signup">SIGNUP</a></li>
            </ul>

            <div class="tab-content">
                <div id="signin" class="tab-pane fade in <c:if test="${requestScope.signupErr eq null}">active</c:if>">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-body">
            ...
            <div id="signup" class="tab-pane fade in <c:if test="${requestScope.signupErr ne null}">active</c:if>">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-body">
