...
public class PublicPostConverter {
	...
	public static PublicDiscussion toPublicDiscussion(DBObject object){
		
		int i=0;
		
		PublicDiscussion pb=new PublicDiscussion(object.get("userId").toString(), object.get("topic").toString(), object.get("content").toString());
